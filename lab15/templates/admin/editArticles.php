...
<?php } ?>
        ...
        <ul>
          ...
          <li>
            <label for="content">Мэдээний агуулга</label>
            <textarea name="content" id="content" placeholder="агуулга хэсэг HTML агуулга оруулж болно" required maxlength="100000" style="height: 30em;"><?php echo htmlspecialchars( $results['article']->content )?></textarea>
          </li>
