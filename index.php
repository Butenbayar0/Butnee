...
<head>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none">Buten</a>
                                    <a href="index.php" class="navbar-brand s-logo-none">Bayr</a>
    ...
    <li class="nav-item"><a class="nav-link" href="#portfolio">Миний хийсэн ажлууд</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s"></h6>
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="front_end_assets/img/banner/Btn.JPG" title="me-01" alt="me-01">
                            </div>
                        </div>
